    ...
    {
      {
        ...
        if(edgearray[*it].v1==s)
            { if(edgearray[*it].v1!=root)
                edgearray[*it].v1vertex=nodearray[root].numberofnodes-nodearray[s].numberofnodes+1;
                else edgearray[*it].v1vertex=nodearray[root].numberofnodes-nodearray[v].numberofnodes;
                edgearray[*it].v2vertex=nodearray[v].numberofnodes;
            }
        else
            {
                if(edgearray[*it].v2!=root)
                edgearray[*it].v2vertex=nodearray[root].numberofnodes-nodearray[s].numberofnodes+1;
                else edgearray[*it].v2vertex=nodearray[root].numberofnodes-nodearray[v].numberofnodes;
